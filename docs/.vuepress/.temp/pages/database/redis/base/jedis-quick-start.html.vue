...
<h2 id="官方地址" tabindex="-1"><a class="header-anchor" href="#官方地址" aria-hidden="true">#</a> 官方地址</h2>
<p>Jedis的官方地址：<a href="https://github.com/redis/jedis" target="_blank" rel="noopener noreferrer">https://github.com/redis/jedis<ExternalLinkIcon/></a></p>
...
<div class="language-text line-numbers-mode" data-ext="text"><pre v-pre class="language-text"><code>result = OK
