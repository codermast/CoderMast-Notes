<template><div><h1 id="java核心-反射" tabindex="-1"><a class="header-anchor" href="#java核心-反射" aria-hidden="true">#</a> Java核心 - 反射</h1>
...
<h2 id="获取class对象" tabindex="-1"><a class="header-anchor" href="#获取class对象" aria-hidden="true">#</a> 获取Class对象</h2>
<p>获取 Class 对象有三种方式：从类、类名、对象获取。</p>
<ul>
<li>从类中获取：Class c = 类名.class</li>
<li>从类名获取：调用 Class 提供的方法<code v-pre>public static Class forName(String package)</code> 用法为 <code v-pre>Class c = Class.forName(&quot;com.codermast.Student&quot;)</code></li>
<li>从对象获取：Object 提供的方法<code v-pre>public Class getClass()</code> 用法为 <code v-pre>Class c = 对象.getClass()</code></li>
</ul>
<p>接下来，简单的演示这三种方法的使用：</p>
<ul>
<li>Studen 类</li>
</ul>
...
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">ReflectionGetClassTest</span> <span class="token punctuation">{</span>
...
<div class="language-text line-numbers-mode" data-ext="text"><pre v-pre class="language-text"><code>true
true
true
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>这说明，无论我们通过那种方式获取的 Class 对象，只要是同一个类，则获取到的 Class 对象都是相同的。本质是类的字节码文件只存储一份。</p>
<h2 id="获取类的构造器" tabindex="-1"><a class="header-anchor" href="#获取类的构造器" aria-hidden="true">#</a> 获取类的构造器</h2>
<p>Class 提供了以下几种从类中获取构造器的方法。</p>
<table>
<thead>
<tr>
...
<td style="text-align:center">获取全部构造器（只能获取 public 修饰的）</td>
</tr>
<tr>
<td style="text-align:center">Constructor&lt;?&gt;[] getDeclareConstructors()</td>
<td style="text-align:center">获取全部构造器（只要存在就能拿到）</td>
</tr>
<tr>
<td style="text-align:center">Constructor&lt;T&gt; getConstructor(Class&lt;?&gt;... parameterTypes)</td>
<td style="text-align:center">获取某个构造器（只能获取 public 修饰的）</td>
</tr>
<tr>
<td style="text-align:center">Constructor&lt;T&gt; getDeclaredConstructor(Class&lt;?&gt;... parameterTypes)</td>
<td style="text-align:center">获取某个构造器（只要存在就能拿到）</td>
</tr>
</tbody>
</table>
<ul>
...
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">ReflectionGetConstructorTest</span> <span class="token punctuation">{</span>
...
<div class="language-text line-numbers-mode" data-ext="text"><pre v-pre class="language-text"><code>===================获取所有 public 的构造器===================
...
<p class="hint-container-title">实例化对象</p>
<p>拿到构造器对象后，可以调用构造器对象内的 newInstace() 方法，来实例化对象。</p>
</div>
<h2 id="获取类的成员变量" tabindex="-1"><a class="header-anchor" href="#获取类的成员变量" aria-hidden="true">#</a> 获取类的成员变量</h2>
<p>Class 提供了以下几种从类中获取成员变量的方法：</p>
<table>
<thead>
<tr>
<th style="text-align:center">方法</th>
...
<td style="text-align:center">获取类的全部成员变量（只能获取 public 修饰的）</td>
</tr>
<tr>
<td style="text-align:center">Field[] getDeclaredFields()</td>
<td style="text-align:center">获取类的全部成员变量（只要存在就能拿到）</td>
</tr>
<tr>
<td style="text-align:center">Field getField(String name)</td>
<td style="text-align:center">获取类的某个成员变量（只能获取 public 修饰的）</td>
</tr>
<tr>
<td style="text-align:center">Field getDeclaredField(String name)</td>
<td style="text-align:center">获取类的某个成员变量（只要存在就能拿到）</td>
</tr>
</tbody>
</table>
<p>操作对象的成员变量有两种类型：set() 设置变量，get() 获取变量</p>
<table>
<thead>
<tr>
<th style="text-align:center">方法</th>
...
<td style="text-align:center">获取对象的成员变量</td>
</tr>
<tr>
<td style="text-align:center">void set(Object obj, Object value)</td>
<td style="text-align:center">设置对象的成员变量</td>
</tr>
<tr>
<td style="text-align:center">public void setAccessible(boolean flag)</td>
<td style="text-align:center">设置为 true，表示禁止检查访问控制（暴力修改）</td>
</tr>
</tbody>
</table>
<ul>
...
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">ReflectionGetFieldTest</span> <span class="token punctuation">{</span>
...
<div class="language-text line-numbers-mode" data-ext="text"><pre v-pre class="language-text"><code>=======所有的 public 成员变量=======
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="获取类的成员方法" tabindex="-1"><a class="header-anchor" href="#获取类的成员方法" aria-hidden="true">#</a> 获取类的成员方法</h2>
<p>Class 提供了以下几种从类中获取成员方法的方法：</p>
<table>
<thead>
<tr>
<th style="text-align:center">方法</th>
...
<td style="text-align:center">获取类的全部成员方法（只能获取 public 修饰的）</td>
</tr>
<tr>
<td style="text-align:center">Method[] getDeclaredMethods()</td>
<td style="text-align:center">获取类的全部成员方法（只要存在就能拿到）</td>
</tr>
<tr>
<td style="text-align:center">Method getMethod(String name, Class&lt;?&gt;... parameterTypes)</td>
<td style="text-align:center">获取类的某个成员方法（只能获取 public 修饰的）</td>
</tr>
<tr>
<td style="text-align:center">Method getDeclaredMethod(String name, Class&lt;?&gt;... parameterTypes)</td>
<td style="text-align:center">获取类的某个成员方法（只要存在就能拿到）</td>
</tr>
</tbody>
</table>
<p>另外获取到的成员方法，也可以调用，使用 invoke() 方法调用。</p>
<table>
<thead>
<tr>
<th style="text-align:center">方法</th>
...
<td style="text-align:center">触发对象 obj 的该方法执行</td>
</tr>
<tr>
<td style="text-align:center">public void setAccessible(boolean flag)</td>
<td style="text-align:center">设置为 true，表示禁止检查访问控制（暴力执行）</td>
</tr>
</tbody>
</table>
<ul>
...
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">ReflectionGetMethodTest</span> <span class="token punctuation">{</span>
...
<div class="language-text line-numbers-mode" data-ext="text"><pre v-pre class="language-text"><code>=======所有的 public 成员方法=======
方法名为：run，参数个数为：0
...
codermast正在跑...
codermast正在吃：米饭
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="反射的作用" tabindex="-1"><a class="header-anchor" href="#反射的作用" aria-hidden="true">#</a> 反射的作用</h2>
<p>经过上面的学习，反射的基本作用就是可以得到一个类的全部成分（成员变量、成员方法、构造器），然后进行操作。</p>
<p>故反射最重要的用途就是适合做 Java 的框架，基本上，主流的框架都会基于反射设计出一些通用的功能。</p>
<p>下面是一个简易的将对象保存到文件中的程序：</p>
<ul>
<li>ObjectFrame</li>
</ul>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">ObjectFrame</span> <span class="token punctuation">{</span>
...
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">ObjectFrameTest</span> <span class="token punctuation">{</span>
...
<div class="language-text line-numbers-mode" data-ext="text"><pre v-pre class="language-text"><code>======Student======
name=codermast
age=18
======Person======
name=小明
