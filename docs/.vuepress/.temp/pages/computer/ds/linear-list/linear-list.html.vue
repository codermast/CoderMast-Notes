<template><div><h1 id="_1-线性表" tabindex="-1"><a class="header-anchor" href="#_1-线性表" aria-hidden="true">#</a> 1. 线性表</h1>
<h2 id="定义和基本操作" tabindex="-1"><a class="header-anchor" href="#定义和基本操作" aria-hidden="true">#</a> 定义和基本操作</h2>
<ul>
<li>
...
<h3 id="顺序表的定义" tabindex="-1"><a class="header-anchor" href="#顺序表的定义" aria-hidden="true">#</a> 顺序表的定义</h3>
<h3 id="基于顺序表的实现" tabindex="-1"><a class="header-anchor" href="#基于顺序表的实现" aria-hidden="true">#</a> 基于顺序表的实现</h3>
<h2 id="线性表的链式表示" tabindex="-1"><a class="header-anchor" href="#线性表的链式表示" aria-hidden="true">#</a> 线性表的链式表示</h2>
<h3 id="单链表的定义" tabindex="-1"><a class="header-anchor" href="#单链表的定义" aria-hidden="true">#</a> 单链表的定义</h3>
<h3 id="基于单链表的实现" tabindex="-1"><a class="header-anchor" href="#基于单链表的实现" aria-hidden="true">#</a> 基于单链表的实现</h3>
</div></template>
