<template><div><h1 id="spring-spring概述" tabindex="-1"><a class="header-anchor" href="#spring-spring概述" aria-hidden="true">#</a> Spring - Spring概述</h1>
<figure><img src="@source/../assets/readme/2023-12-29-20-51-14.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure>
<h2 id="spring-是什么" tabindex="-1"><a class="header-anchor" href="#spring-是什么" aria-hidden="true">#</a> Spring 是什么？</h2>
...
<h2 id="spring-framework的特点" tabindex="-1"><a class="header-anchor" href="#spring-framework的特点" aria-hidden="true">#</a> Spring Framework的特点</h2>
<ul>
<li>
...
<li>
<p>组件化：Spring 实现了使用简单的组件配置组合成一个复杂的应用。在 Spring 中可以使用 XML 和 Java 注解组合这些对象。这使得我们可以基于一个个功能明确、边界清晰的组件有条不紊的搭建超大型复杂应用系统。</p>
</li>
<li>
<p>一站式：在 IoC 和 AOP 的基础上可以整合各种企业应用的开源框架和优秀的第三方类库。而且 Spring 旗下的项目已经覆盖了广泛领域，很多方面的功能性需求可以在 Spring Framework 的基础上全部使用 Spring 来实现。</p>
</li>
</ul>
<h2 id="spring-模块组成" tabindex="-1"><a class="header-anchor" href="#spring-模块组成" aria-hidden="true">#</a> Spring 模块组成</h2>
<figure><img src="@source/../assets/spring-summarize/2023-12-29-20-53-33.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure>
...
<ul>
<li>
<p>spring-core ：IOC和DI的基本实现</p>
</li>
<li>
<p>spring-beans：BeanFactory和Bean的装配管理(BeanFactory)</p>
</li>
<li>
<p>spring-context：Spring context上下文，即IOC容器(AppliactionContext)</p>
</li>
<li>
<p>spring-expression：spring表达式语言</p>
</li>
</ul>
