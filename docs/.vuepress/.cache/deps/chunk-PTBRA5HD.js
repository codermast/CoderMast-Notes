...
var loader$i = async () => {
  const { diagram } = await import("./c4Diagram-f9e67060-LS5EW7KI.js");
...
var loader$h = async () => {
  const { diagram } = await import("./flowDiagram-42bb1e4d-7T53E33N.js");
...
var loader$g = async () => {
  const { diagram } = await import("./flowDiagram-v2-4c9a7611-UYOMWZ37.js");
...
var loader$f = async () => {
  const { diagram } = await import("./erDiagram-25977acd-XNPBV4JP.js");
...
var loader$e = async () => {
  const { diagram } = await import("./gitGraphDiagram-30dcca6d-C33SFKGB.js");
...
var loader$d = async () => {
  const { diagram } = await import("./ganttDiagram-41439120-26FOP2J4.js");
...
var loader$b = async () => {
  const { diagram } = await import("./pieDiagram-905ac727-5N4J7QQZ.js");
...
var loader$a = async () => {
  const { diagram } = await import("./requirementDiagram-84e9ae78-LRFZSHS6.js");
...
var loader$9 = async () => {
  const { diagram } = await import("./sequenceDiagram-2c95880e-MFNZP4RY.js");
...
var loader$8 = async () => {
  const { diagram } = await import("./classDiagram-4456d403-2DAXPZKW.js");
...
var loader$7 = async () => {
  const { diagram } = await import("./classDiagram-v2-539b00ca-CGZZI7HI.js");
...
var loader$6 = async () => {
  const { diagram } = await import("./stateDiagram-95825141-KB6V35XW.js");
...
var loader$5 = async () => {
  const { diagram } = await import("./stateDiagram-v2-1cc5d8ed-YUXXEBY6.js");
...
var loader$4 = async () => {
  const { diagram } = await import("./journeyDiagram-ded66ec9-BX5MVE7O.js");
...
var loader$2 = async () => {
  const { diagram } = await import("./flowchart-elk-definition-c9fc5e04-ICQCWTSM.js");
...
//# sourceMappingURL=chunk-PTBRA5HD.js.map
